...
12. [2026-08-02 查询性能第三轮](query-performance-round3-2026-08-02.html)：显式热查询缓存、严格零退化门、系统级差距与被拒绝候选。
13. [开发路线](development-plan.md)：里程碑、依赖和完成定义。
14. [架构决策](decisions/README.md)：已经接受的公共接口、连接、Group Commit、WAL 维护、类型化 Schema、索引、迁移、查询约束和故障注入边界。
